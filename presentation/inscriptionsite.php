...
<body>
    ...
    <!-- Modal -->
    <div class="modal fade" id="btnIns" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header ">
                    <h5 class="modal-title " id="EspPerso">Espace perso</h5>
                ...
                <div class="globalConnexion text-center">
                    ...
                    <div class="identifantsCo justify-content-center pt-3 ">
                        ...
                        <!-- mot de passe -->
                        <div class="identifiants pt-3 row justify-content-center" id="mdp">
                ...
                <button type="submit" class="btn btn-success color-228B22 mb-10" id="boutonsubmit" name="connecter" hre="../controller/controllerUserConnect.php?action=connexion"> Se connecter </button> </br>

                    </form>
                <button type="button" class="btn btn-success color-228b22" id ="boutoninscription" hre="../controller/controllerUserConnect.php?../controller/controllerUserConnect.php?action=afficherInscription" data-toggle="modal" data-target="#modalInscription">
                    S'inscrire
                </button>
                
                <!-- Modal dans le modal -->
                <div class="modal  fade bd-example-modal-lg" id="modalInscription" tabindex="-1" role="dialog" aria-labelledby="modalInscriptionLabel" aria-hidden="true">
                    <div role="document" >
                        <div class="modal-content">
                            <!-- header du modal -->
                            ...
                            <div class="globalConnexion text-center p-2">
                                <form action="../controller/controllerUserConnect.php?action=inscription" method="post">
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-success color-228B22 mb-10" name="inscrire" id="boutonsubmit"> Valider l'inscription </button> </br>
                                </form>
                            </div>                
                        </div>
                    </div>
